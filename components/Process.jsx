...
const steps = [
  {
    icon: <Search size={28} />,
    title: "Discovery",
    desc: "We dive deep into your brand, audience, and goals to build a winning strategy.",
    color: "bg-blue-500",
  },
  {
    icon: <PenTool size={28} />,
    title: "Design",
    desc: "Crafting visually stunning, user-centric interfaces that embody your brand identity.",
    color: "bg-purple-500",
  },
  {
    icon: <Code2 size={28} />,
    title: "Development",
    desc: "Writing clean, scalable code to bring the designs to life with top-tier performance.",
    color: "bg-green-500",
  },
  {
    icon: <Rocket size={28} />,
    title: "Launch",
    desc: "Seamless deployment and post-launch support to ensure your product soars.",
    color: "bg-orange-500",
  },
];
